  ...
  return (
    <div className="flex flex-col items-center px-6 md:px-16 lg:px-24 bg-slate-50 pt-20 pb-32">
      <Title
        ...
        subTitle="Discover why discerning travelers consistently choose StayNest for their exclusive and luxurious accommodations around the world."
      />
      
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-20 w-full">
