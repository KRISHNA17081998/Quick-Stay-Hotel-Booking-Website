  ...
  return (
    <label className="flex gap-3 items-center cursor-pointer mt-2 text-sm">
      <input
        type="checkbox"
        checked={selected}
        onChange={(e) => onChange(e.target.checked, label)} // Fixed onchange -> onChange
      />
  ...
  return (
    <label className="flex gap-3 items-center cursor-pointer mt-2 text-sm">
      <input
        ...
        name="sortOption"
        checked={selected}
        onChange={() => onChange(label)} // Fixed onchange -> onChange
      />
      <span className="font-light selected-none">{label} </span>
    </label>
  );
...
const Allrooms = () => {
  ...
  const priceRanges = ['0 to 500', '100 to 1000', '1000 to 2000', '2000 to 3000'];
