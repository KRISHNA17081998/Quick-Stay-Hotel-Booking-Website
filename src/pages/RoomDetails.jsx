...
p-6 rounded-xl mx-auto mt-16 max-w-6xl'>
    ...
    <button type='submit' className='bg-primary hover:bg-primary-dull active:scale-95 transition-all text-white rounded-md max-md:w-full max-md:mt-6 
    ...
    {roomCommonData.map((spec, index)=>(
        <div key={index} className='flex items-start gap-2'>
            ...
            <div>
             ...
             <p className='text-grey-500'> {spec.description} </p>
             </div>
             </div>
